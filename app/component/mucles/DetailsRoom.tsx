...
export default function DetailsRoom() {
  return (
    <div className="mt-10">
      <div className="p-4 mt-4 overflow-hidden border rounded-sm">
            ...
            <div className="col-span-2 ">
              ...
              <div className="h-full bg-white border-l">
                ...
                <div className="text-center">
                    <span className="text-[#bc9c2e] text-[10px] m-auto">Coupon 7PCTCAP17MIN250 applied</span>
                </div>
                ...
                <div className="m-auto mt-4 text-end">
                    <p className="text-red-500">Our last 5 rooms!
