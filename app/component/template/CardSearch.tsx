    ...
    >
      <Group noWrap spacing={0}>
        <div className="grid grid-cols-12">
          ...
          <div className={`${classes.body} py-0 px-1 col-span-6`}>
            <div className="p-2">
              <Group className="flex gap-1">
                <div className="flex bg-[#5d22d529]  px-1 rounded-lg items-center">
                  <IconStar className="text-xs text-[#5d22d5] fill-bg_banfsgy w-[15px] " />
                  <p className="text-[#5d22d5] font-bold px-1 text-[13px]">
                    Luxury
                  </p>
                </div>
                <div className="flex bg-[#5d22d529]  px-1 rounded-lg items-center">
              ...
              <Group className="mt-10">
                ...
                <p className="text-sm">1,426 Reviews | 4-Star Hotel</p>
              </Group>
            </div>
          </div>
          <div
            className={`${classes.body} border-l border-l-gray-500-500 col-span-3`}
          >
            <div className="flex flex-col items-center justify-between text-center gap-[68px]">
              <div>
                <p className="text-[#5e22d5bd] font-bold text-sm ">Stay Expo</p>
